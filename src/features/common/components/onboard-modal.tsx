...
import { useOnboardUser } from '@/features/auth/hooks/use-auth';
...
export default function OnboardModal({
  ...
  const onSubmit: SubmitHandler<OnboardingValues> = (values) => {
    ...
    if (!values.whereAreYouFrom || !values.whereDoYouWantToGo) {
      form.setError('whereAreYouFrom', { message: 'This field is required' });
      form.setError('whereDoYouWantToGo', {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>
            Please complete your onboarding to get the best experience on
            RotateKey!
          </DialogTitle>
          <DialogDescription>
            We just need a few details to personalize your experience. It will
            only take a moment!
          </DialogDescription>
        </DialogHeader>
        <div>
